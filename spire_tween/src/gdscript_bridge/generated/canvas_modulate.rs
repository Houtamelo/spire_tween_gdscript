use super::*;
/**This class provides shortcut constructors to create tweens that animate a [CanvasModulate].

[b]Note:[/b] This class is not meant to be instantiated. To animate properties of a base class, use the methods in the "namespace" `Do[BaseClass]` instead (replace `[BaseClass]` with the base class' name).*/
#[derive(GodotClass)]
#[class(base = Object, no_init)]
pub struct DoCanvasModulate {}
#[godot_api]
impl DoCanvasModulate {
    /**[b]Behavior: [/b]Tweens the `r` component of the property [member CanvasModulate.color] over [param duration] seconds.
