...
[b]Returns:[/b] A handle that can be used to further customize the tween.*/
    ...
    fn r#drag_horizontal_offset(
        ...
        let tween = node.do_drag_horizontal_offset(to, duration).register();
...
[b]Returns:[/b] A handle that can be used to further customize the tween.*/
    ...
    fn r#drag_vertical_offset(
        ...
        let tween = node.do_drag_vertical_offset(to, duration).register();
        gd_from_native_tween(tween)
    }
...
[b]Returns:[/b] A handle that can be used to further customize the tween.*/
    ...
    fn r#drag_left_margin(
        ...
        let tween = node.do_drag_left_margin(to, duration).register();
        gd_from_native_tween(tween)
    }
...
[b]Returns:[/b] A handle that can be used to further customize the tween.*/
    ...
    fn r#drag_right_margin(
        ...
        let tween = node.do_drag_right_margin(to, duration).register();
        gd_from_native_tween(tween)
    }
...
[b]Returns:[/b] A handle that can be used to further customize the tween.*/
    ...
    fn r#drag_top_margin(
        ...
        let tween = node.do_drag_top_margin(to, duration).register();
        gd_from_native_tween(tween)
    }
...
[b]Returns:[/b] A handle that can be used to further customize the tween.*/
    ...
    fn r#drag_bottom_margin(
        ...
        let tween = node.do_drag_bottom_margin(to, duration).register();
        gd_from_native_tween(tween)
    }
...
[b]Returns:[/b] A handle that can be used to further customize the tween.*/
    ...
    fn zoom_x(node: Gd<Camera2D>, to: f64, duration: f64) -> Gd<SpirePropertyFloat> {
        let tween = node.do_zoom_x(to, duration).register();
        gd_from_native_tween(tween)
    }
...
[b]Returns:[/b] A handle that can be used to further customize the tween.*/
    ...
    fn zoom_y(node: Gd<Camera2D>, to: f64, duration: f64) -> Gd<SpirePropertyFloat> {
        let tween = node.do_zoom_y(to, duration).register();
        gd_from_native_tween(tween)
    }
