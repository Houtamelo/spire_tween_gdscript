...
[b]Returns:[/b] A handle that can be used to further customize the tween.*/
    ...
    fn r#fov(node: Gd<Camera3D>, to: f64, duration: f64) -> Gd<SpirePropertyFloat> {
        let tween = node.do_fov(to, duration).register();
...
[b]Returns:[/b] A handle that can be used to further customize the tween.*/
    ...
    fn frustum_offset_x(
        ...
        let tween = node.do_frustum_offset_x(to, duration).register();
        gd_from_native_tween(tween)
    }
...
[b]Returns:[/b] A handle that can be used to further customize the tween.*/
    ...
    fn frustum_offset_y(
        ...
        let tween = node.do_frustum_offset_y(to, duration).register();
        gd_from_native_tween(tween)
    }
