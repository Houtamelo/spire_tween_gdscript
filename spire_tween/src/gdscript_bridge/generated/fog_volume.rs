use super::*;
/**This class provides shortcut constructors to create tweens that animate a [FogVolume].

[b]Note:[/b] This class is not meant to be instantiated. To animate properties of a base class, use the methods in the "namespace" `Do[BaseClass]` instead (replace `[BaseClass]` with the base class' name).*/
#[derive(GodotClass)]
#[class(base = Object, no_init)]
pub struct DoFogVolume {}
#[godot_api]
impl DoFogVolume {
    /**[b]Behavior: [/b]Tweens the `x` component of the property [member FogVolume.size] over [param duration] seconds.
