class_name TweenPropertyVector2
const State = preload("res://handle/tween_handle.gd").State

var tween: InternalTweenPropertyVector2

func _init(p_tween: InternalTweenPropertyVector2):
	tween = p_tween
...
func from(value: Vector2) -> TweenPropertyVector2:
	tween.set_start_value(value)
	return self

func with_ease(p_ease: Variant) -> TweenPropertyVector2:
	tween = tween.with_ease(p_ease)
	return self

func set_absolute() -> TweenPropertyVector2:
	tween.set_absolute()
	return self

func set_speed_based(speed: float) -> TweenPropertyVector2:
	tween.set_speed_based(speed)
	return self

func set_relative(to: Vector2 = Vector2.ZERO) -> TweenPropertyVector2:
