class_name TweenPropertyI64
const State = preload("res://handle/tween_handle.gd").State

var tween: InternalTweenPropertyI64

func _init(p_tween: InternalTweenPropertyI64):
	tween = p_tween
...
func from(value: int) -> TweenPropertyI64:
	tween.set_start_value(value)
	return self

func with_ease(p_ease: Variant) -> TweenPropertyI64:
	tween = tween.with_ease(p_ease)
	return self

func set_absolute() -> TweenPropertyI64:
	tween.set_absolute()
	return self

func set_speed_based(speed: float) -> TweenPropertyI64:
	tween.set_speed_based(speed)
	return self

func set_relative(to: int = 0) -> TweenPropertyI64:
